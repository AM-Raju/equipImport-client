...
const ContactPage = () => {
  return (
    <div className="container mx-auto px-6 pb-12">
      <section className="w-full h-auto ">
        <div className=" mx-auto  grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative h-64 w-full col-span-3">
            <div className="absolute inset-0 bg-[url('https://i.ibb.co.com/x033W2N/testimonial-bg.webp')]   bg-cover bg-center opacity-60"></div>
            <div className="relative  text-flame-red p-4 flex items-center justify-center h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-8 md:gap-x-8 mt-12">
        <div className="bg-white p-6 shadow-xs border border-flame-red text-primary-green w-full mx-auto ">
        ...
        {/* Contact Form */}
        <div className="bg-white shadow-lg border border-flame-red p-6 w-full mx-auto lg:col-span-2">
          ...
          <form className="space-y-4">
            <div className="lg:flex gap-2 lg:gap-6">
              <div className="flex-1">
                ...
                <input
                  type="text"
                  className="w-full px-4 py-2 border border-flame-red rounded-md focus:ring focus:ring-blue-400 outline-none "
